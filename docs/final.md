...
### 3.1 Approach: Customize PPO Trainer
...
For the final version, we consider several factors when giving our agent rewards. The reward formula is consist of two part:  **W(s) = P(s) + R(s)**
